...
const xoadm = async function(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = '/admin/cate/delete/' + id;
        }
    })
}


const suadm = async function(id) {
    window.location.href = '/admin/cate/edit/' + id;
}

const xoablog = async function(id) {
    Swal.fire({
        title: 'Xoá?',
        text: "Bạn có chắc xoá không!",
        icon: 'warning',
